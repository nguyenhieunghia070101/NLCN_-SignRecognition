...
public class DetectorGallery extends AppCompatActivity {
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            setContentView(R.layout.detect_gallery);
...
//        getSupportActionBar().setDisplayShowTitleEnabled(true);
            ...
            txtResult1 = (TextView) findViewById(R.id.result1);
...
//            }
            ...
            if(maxpos == -1) {
                ...
                //getDetect(maxpos+1);
                //String xs =String.format("Phát hiện ra %d biển báo", count);
                //txtResult1.setText(xs);
                txtResult.setText(s);
            }
        }
        @Override
